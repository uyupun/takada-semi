...
- 少し前に発表した [生成AI関連ツールを使い倒す](https://semi.uyupun.tech/presentations/2025/04-23/kazukichi/) では検証できなかったサービスを検証していく
...
- NotebookLM自体は以前に触れた
	- [生成AI関連ツールを使い倒す > NotebookLM](https://semi.uyupun.tech/presentations/2025/04-23/kazukichi/#notebooklm)
