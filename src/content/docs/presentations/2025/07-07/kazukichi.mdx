...
- MCP
	...
	- 詳しくは [Middle Dive MCP](https://semi.uyupun.tech/presentations/2025/04-30/kazukichi/) と [MCPサーバの活用と構築](https://semi.uyupun.tech/presentations/2025/05-07/kazukichi/)
- A2A
	- AIエージェント間の通信を標準化するプロトコル
	- 詳しくは [A2A - MCPのその先へ](https://semi.uyupun.tech/presentations/2025/05-14/kazukichi/)
