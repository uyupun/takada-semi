...
- [高田ゼミ](https://semi.uyupun.tech/) でもAstroを活用しているのでなんとなく使い勝手が想像できる
- シンプルに開発できる
- JSXが書ける
...
- チーム内にもある程度、知見がある
	- むらたさんの記事: [ClaudeCode と Claude4Opus だけでで Cloudflare Pages 上にプロフィールページ作ってみた](https://semi.uyupun.tech/presentations/2025/07-07/murata/)
- デプロイが簡単
- Astroと相性が良い
