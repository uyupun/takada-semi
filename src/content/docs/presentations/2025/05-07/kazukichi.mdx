...
- [Knowledge Graph Memory Server](https://github.com/modelcontextprotocol/servers/tree/main/src/memory) を使ってみる
    ...
    - [Middle Dive MCP](https://semi.uyupun.tech/presentations/2025/04-30/kazukichi/) でも少し触れた
...
- 使ってみた感想
  ...
  - また、これはMCPサーバ全般に言えることだが、現状はまだローカルでMCPサーバを起動して標準入出力で接続するというのが一般的
    ...
    - この辺の仕様に関しては [Middle Dive MCP](https://semi.uyupun.tech/presentations/2025/04-30/kazukichi/) でも触れた
